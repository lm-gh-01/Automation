...
param(
    ...
    [String] $AzureCredentialName = "AzureRunAsConnection",
    [parameter(Mandatory=$false)]
    [String] $AzureSubscriptionName = "Global Infrastructure",
    [parameter(Mandatory=$false)]
    [bool]$Simulate = $true
)
...
try
{
    ...
    try {
        ...
        $servicePrincipalConnection = Get-AutomationConnection -Name $AzureCredentialName
